...
def bot_sys_stats():
    ...
    for download in download_dict.values():
        ...
        if status in MirrorStatus.STATUS_QUEUEDL or status in MirrorStatus.STATUS_QUEUEUP:
            ...
            seed += 1
    bmsg = f'______BNxZee Mirror Info______\n\n'
...
async def stats(_, message, edit_mode=False):
    ...
    bot_stats = f'<b><i><u>BNxZee Mirror Statistics</u></i></b>\n\n'\
    ...
    sys_stats = f'<b><i><u>BNxZee System Statistics</u></i></b>\n\n'\
...
async def send_repo_stats(_, query):
    ...
    repo_stats = f'<b><i><u>BNxZee Repository Info</u></i></b> \n\n' \
...
async def send_bot_limits(_, query):
    ...
    bot_limit = f'<b><i><u>BNxZee Bot Limitations</u></i></b>\n' \
